import { Link2, ShieldCheck, BarChart3, Copy, MousePointer} from "lucide-react";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div className="text-center lg:text-left order-2 lg:order-1">
          ...
          <p className="mt-5 text-slate-500 text-base sm:text-lg leading-7 max-w-xl mx-auto lg:mx-0">
            ShortURL is a fast, reliable and easy way to shorten long
          ...
          <div className="mt-8 bg-white rounded-2xl shadow-md p-2 flex flex-col sm:flex-row gap-2 max-w-xl mx-auto lg:mx-0">
            ...
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 sm:px-8 py-3 rounded-xl font-medium transition">
              Shorten URL
            </button>
